...
public class Index extends JFrame {
	...
	private JTextField textFieldKey3; // Thêm TextField cho khóa thứ ba
	...
	public void encrypt() {
		try {
			...
			String key3 = textFieldKey3.getText(); // Lấy giá trị từ TextField cho khóa thứ ba
	...
	public void decrypt() {
		try {
			...
			byte[] byteDecrypted3 = decryptDES(key3, Base64.getDecoder().decode(encryptText));
	...
	public Index() {
		...
		//Thêm Label và TextField cho khóa thứ ba
